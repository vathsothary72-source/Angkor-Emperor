...
export const initialLicenses: License[] = [
  {
    ...
    max_devices: 5,
    used_devices: 3,
    user_name: 'Angkor Solutions Ltd',
  ...
  },
  {
    ...
    max_devices: 3,
    used_devices: 2,
    user_name: 'Sok Vicheth (Lead Dev)',
  ...
  },
  {
    ...
    max_devices: 4,
    used_devices: 2,
    user_name: 'Dr. Sun Heng (Research Lab)',
